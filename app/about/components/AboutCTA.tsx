    ...
    <section className="py-16 px-4 md:px-8">
      <div className="max-w-5xl mx-auto">
        <motion.div
          ...
          className="bg-black/5 backdrop-blur-md border border-purple-500/20 rounded-lg p-8 md:p-12 text-center"
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Experience AI You Can Trust?</h2>
          <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            See how PSQRD can transform your operations with guaranteed accuracy, source transparency, and unprecedented
            efficiency.
          </p>
