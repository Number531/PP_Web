...
import { useVisibleFeatures } from "@/app/shared/store/explorer-store"
...
export const FeatureMarkers = memo(function FeatureMarkers({
  ...
  // Get visible features based on scroll progress using the store selector
  const visibleFeatures = useVisibleFeatures(scrollProgress)
